...
type
  TfrmSenha = class(TForm)
    ...
    procedure rectAcougueNormalMouseDown(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Single);
    procedure layAcougueNormalMouseDown(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Single);
    procedure layAcougueNormalMouseLeave(Sender: TObject);
    procedure layAcouguePreferencialMouseLeave(Sender: TObject);
    procedure layAcouguePreferencialMouseDown(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Single);
    procedure layPadariaNormalMouseDown(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Single);
    procedure layPadariaPreferencialMouseDown(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Single);
    procedure layPadariaNormalMouseLeave(Sender: TObject);
    procedure layPadariaPreferencialMouseLeave(Sender: TObject);
  private
...
procedure TfrmSenha.layPadariaNormalMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Single);
begin
  rectPadariaNormal.Fill.Color:= $FFB97505;
end;

procedure TfrmSenha.layPadariaNormalMouseLeave(Sender: TObject);
begin
  rectPadariaNormal.Fill.Color:= $FFFF9F03;
end;

procedure TfrmSenha.layPadariaPreferencialMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Single);
begin
  rectPadariaPreferencial.Fill.Color:= $FFB97505;
end;

procedure TfrmSenha.layPadariaPreferencialMouseLeave(Sender: TObject);
begin
  rectPadariaPreferencial.Fill.Color:= $FFFF9F03;
end;

procedure TfrmSenha.rectAcougueNormalMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Single);
begin
  rectAcougueNormal.Fill.Color:=  $FF06894F;
end;

procedure TfrmSenha.layAcougueNormalMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Single);
begin
  rectAcougueNormal.Fill.Color:=  $FF06894F;
end;

procedure TfrmSenha.layAcougueNormalMouseLeave(Sender: TObject);
begin
  rectAcougueNormal.Fill.Color:=  $FF06C26E;
end;

procedure TfrmSenha.layAcouguePreferencialMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Single);
begin
  rectAcouguePreferencial.Fill.Color:=  $FF06894F;
end;

procedure TfrmSenha.layAcouguePreferencialMouseLeave(Sender: TObject);
begin
  rectAcouguePreferencial.Fill.Color:=  $FF06C26E;
end;
