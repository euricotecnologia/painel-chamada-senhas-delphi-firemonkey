...
//  ppDesigner1.Report := ppReport1;
  ppReport1.Template.FileName := tpath.Combine(ExtractFilePath(ParamStr(0)), 'impressao.rtm');
...
//  if FileExists(tpath.Combine(ExtractFilePath(ParamStr(0)), 'impressao.rtm')) then
//    ppSenha.Template.FileName := tpath.Combine(ExtractFilePath(ParamStr(0)), 'impressao.rtm');
//
//  ppSenha.Template.LoadFromFile;
end;
