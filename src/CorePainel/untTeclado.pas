...
type
  TfrmTeclado = class(TForm)
    ...
    procedure rectNum1MouseDown(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Single);
    procedure rectNum1MouseLeave(Sender: TObject);
    procedure rectNum0MouseDown(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Single);
    procedure rectNum0MouseLeave(Sender: TObject);
  private
...
procedure TfrmTeclado.rectNum0MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
  rectNum1.Fill.Color:= $FF36394B;
end;

procedure TfrmTeclado.rectNum0MouseLeave(Sender: TObject);
begin
  rectNum1.Fill.Color:= $FF606481;
end;
...
procedure TfrmTeclado.rectNum1MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
  rectNum1.Fill.Color:= $FF47495B;
end;

procedure TfrmTeclado.rectNum1MouseLeave(Sender: TObject);
begin
  rectNum1.Fill.Color:= $FF606481;
end;
