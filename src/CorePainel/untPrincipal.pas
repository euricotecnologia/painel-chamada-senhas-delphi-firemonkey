...
type
  ...
  private
    ...
    procedure TakePermissionRequestResult(Sender: TObject;
      const APermissions: TArray<string>;
      const AGrantResults: TArray<TPermissionStatus>);
    procedure DisplayMessage(Sender: TObject; const APermissions: TArray<string>; const APostProc: TProc);
...
procedure TfrmPrincipal.DisplayMessage(Sender: TObject; const APermissions: TArray<string>; const APostProc: TProc);
begin
  TDialogService.ShowMessage('O app precisa ler e gravar arquivos no dispositivo!',
...
procedure TfrmPrincipal.TakePermissionRequestResult(Sender: TObject; const APermissions: TArray<string>; const AGrantResults: TArray<TPermissionStatus>);
begin
  if (Length(AGrantResults) = 3)
    ...
    TDialogService.ShowMessage('Você não tem permissão para acessar os dados!');
end;
