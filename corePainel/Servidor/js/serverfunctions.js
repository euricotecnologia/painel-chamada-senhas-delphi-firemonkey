...
{
  this.executor = new ServerFunctionExecutor("display",connectionInfo);
  ...
  /*
   * @param aJson [in] - Type on server: TJSONObject
   * @return result - Type on server: TJSONObject
   */
  this.updatedisplay = function(aJson) {
    var returnObject = this.executor.executeMethod('display', "POST", [aJson], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
   ...
   * @return result - Type on server: TJSONObject
   */
  this.updatedisplayespecifico = function(aJson) {
    var returnObject = this.executor.executeMethod('displayespecifico', "POST", [aJson], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
   ...
   * @return result - Type on server: TJSONObject
   */
  this.updatefrase = function(aJson) {
    var returnObject = this.executor.executeMethod('frase', "POST", [aJson], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
   ...
   * @return result - Type on server: TJSONObject
   */
  this.updateconfiguracoes = function(aJson) {
    var returnObject = this.executor.executeMethod('configuracoes', "POST", [aJson], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.configuracoes = function() {
    var returnObject = this.executor.executeMethod('configuracoes', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.configuracoes_URL = function() {
    return this.executor.getMethodURL("configuracoes", "GET", [], arguments[0])[0];
  };
   ...
   */
  this.frase = function() {
    var returnObject = this.executor.executeMethod('frase', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.frase_URL = function() {
    return this.executor.getMethodURL("frase", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: TJSONObject
   */
  this.senhas = function() {
    var returnObject = this.executor.executeMethod('senhas', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.senhas_URL = function() {
    return this.executor.getMethodURL("senhas", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: TJSONObject
   */
  this.padaria = function() {
    var returnObject = this.executor.executeMethod('padaria', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.padaria_URL = function() {
    return this.executor.getMethodURL("padaria", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: TJSONObject
   */
  this.acougue = function() {
    var returnObject = this.executor.executeMethod('acougue', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.acougue_URL = function() {
    return this.executor.getMethodURL("acougue", "GET", [], arguments[0])[0];
  };

  /*
   * @param aTipo [in] - Type on server: string
   * @return result - Type on server: TJSONObject
   */
  this.chamaproximo = function(aTipo) {
    var returnObject = this.executor.executeMethod('chamaproximo', "GET", [aTipo], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.aTipo = aTipo;
        resultObject.result = resultArray[0];
        if (returnObject.cacheId != null && returnObject.cmdIndex != null) {
          resultObject._cacheId = returnObject.cacheId;
          resultObject._cmdIndex = returnObject.cmdIndex;
  ...
  this.chamaproximo_URL = function(aTipo) {
    return this.executor.getMethodURL("chamaproximo", "GET", [aTipo], arguments[1])[0];
  };

  /*
   * @return result - Type on server: TJSONObject
   */
  this.chamarnovamente = function() {
    var returnObject = this.executor.executeMethod('chamarnovamente', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.chamarnovamente_URL = function() {
    return this.executor.getMethodURL("chamarnovamente", "GET", [], arguments[0])[0];
  };
   ...
   * @return result - Type on server: TJSONObject
   */
  this.updateconfiguradisplay = function(aJson) {
    var returnObject = this.executor.executeMethod('configuradisplay', "POST", [aJson], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
   ...
   * @return result - Type on server: TJSONObject
   */
  this.updateconfiguradisplay1 = function(aJson) {
    var returnObject = this.executor.executeMethod('configuradisplay1', "POST", [aJson], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
   ...
   * @return result - Type on server: TJSONObject
   */
  this.configuracaoimpressao = function() {
    var returnObject = this.executor.executeMethod('configuracaoimpressao', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.configuracaoimpressao_URL = function() {
    return this.executor.getMethodURL("configuracaoimpressao", "GET", [], arguments[0])[0];
  };
   ...
   * @return result - Type on server: TJSONObject
   */
  this.updateconfiguracaoimpressao = function(aJson) {
    var returnObject = this.executor.executeMethod('configuracaoimpressao', "POST", [aJson], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
   ...
   * @return result - Type on server: TJSONObject
   */
  this.imprimirpadarianormal = function() {
    var returnObject = this.executor.executeMethod('imprimirpadarianormal', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.imprimirpadarianormal_URL = function() {
    return this.executor.getMethodURL("imprimirpadarianormal", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: TJSONObject
   */
  this.imprimirpadariapreferencial = function() {
    var returnObject = this.executor.executeMethod('imprimirpadariapreferencial', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.imprimirpadariapreferencial_URL = function() {
    return this.executor.getMethodURL("imprimirpadariapreferencial", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: TJSONObject
   */
  this.imprimiracouguenormal = function() {
    var returnObject = this.executor.executeMethod('imprimiracouguenormal', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.imprimiracouguenormal_URL = function() {
    return this.executor.getMethodURL("imprimiracouguenormal", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: TJSONObject
   */
  this.imprimiracouguepreferencial = function() {
    var returnObject = this.executor.executeMethod('imprimiracouguepreferencial', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.imprimiracouguepreferencial_URL = function() {
    return this.executor.getMethodURL("imprimiracouguepreferencial", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: TJSONObject
   */
  this.resetasenhas = function() {
    var returnObject = this.executor.executeMethod('resetasenhas', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.resetasenhas_URL = function() {
    return this.executor.getMethodURL("resetasenhas", "GET", [], arguments[0])[0];
  };
   ...
   * @return result - Type on server: TJSONObject
   */
  this.updateresetsenhas = function(aJSon) {
    var returnObject = this.executor.executeMethod('resetsenhas', "POST", [aJSon], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
   ...
   * @return result - Type on server: TJSONObject
   */
  this.updateconfigurasom = function(aJson) {
    var returnObject = this.executor.executeMethod('configurasom', "POST", [aJson], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
   ...
   * @return result - Type on server: TJSONObject
   */
  this.configurasom = function() {
    var returnObject = this.executor.executeMethod('configurasom', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.configurasom_URL = function() {
    return this.executor.getMethodURL("configurasom", "GET", [], arguments[0])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "display": ["DSServerModuleCreate","DSServerModuleDestroy","updatedisplay","updatedisplayespecifico","updatefrase","updateconfiguracoes","configuracoes","frase","senhas","padaria","acougue","chamaproximo","chamarnovamente","updateconfiguradisplay","updateconfiguradisplay1","configuracaoimpressao","updateconfiguracaoimpressao","imprimirpadarianormal","imprimirpadariapreferencial","imprimiracouguenormal","imprimiracouguepreferencial","resetasenhas","updateresetsenhas","updateconfigurasom","configurasom"]
};
